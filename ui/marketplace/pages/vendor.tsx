    ...
    <Layout title="Vendor Dashboard">
      <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-secondary/20">
        <div className="relative overflow-hidden bg-gradient-to-r from-teal-500/10 via-primary/5 to-violet-500/10 border-b border-border/50">
          ...
          <div className="relative max-w-7xl mx-auto px-6 py-12">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-4xl font-bold neural-text mb-4">Vendor Dashboard</h1>
                <p className="text-xl text-muted-foreground">Welcome back, {vendorData.name}</p>
              </div>
              <button className="atom-gradient text-white px-6 py-3 rounded-lg font-medium hover:opacity-90">
                🚀 Publish New Item
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold neural-text mb-6">🧠 Your Models</h2>
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold neural-text mb-6">🤖 Your Agents</h2>
            <div className="quantum-card overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-secondary/20">
          ...
          <div className="quantum-card p-6">
            <h3 className="text-xl font-bold neural-text mb-4">📊 Revenue Analytics</h3>
